  ...
  <li :class="dropdownClasses" class="nav-item">
    ...
    <ul :class="isMenu" class="dropdown-menu-right" v-if="notifications.length">
      ...
      <li class="dropdown-item">
        <a class="dropdown-item" @click="markAllAsRead()" href="#">Marcar todo como leido</a>
      </li>
      <li class="dropdown-item">
        <a class="dropdown-item" :href="linkToAllNotifications">Ver Todas las Notificaciones</a>
      </li>
    </ul>
  </li>
</template>
